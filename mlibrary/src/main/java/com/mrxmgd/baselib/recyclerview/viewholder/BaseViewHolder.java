...
package com.mrxmgd.baselib.recyclerview.viewholder;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setOnClickListener(int viewId, BaseQuickRecycleAdapter.OnItemChildClickListener listener) {
        View view = getView(viewId);
     ...
     * @return
     */
    public BaseViewHolder setOnLongClickListener(int viewId, BaseQuickRecycleAdapter.OnItemChildLongClickListener listener) {
        View view = getView(viewId);
        listener.mViewHolder = this;
