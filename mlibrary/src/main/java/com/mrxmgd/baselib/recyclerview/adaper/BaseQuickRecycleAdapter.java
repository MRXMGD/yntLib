...
package com.mrxmgd.baselib.recyclerview.adaper;
 ...
 */
public abstract class BaseQuickRecycleAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(BaseQuickRecycleAdapter adapter, View view, int position);
    }
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null)
                mChildClickListener.onItemChildClick(BaseQuickRecycleAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewsCount());
        }
    }
    ...
    public interface OnRecyclerViewItemChildLongClickListener {
        boolean onItemChildLongClick(BaseQuickRecycleAdapter adapter, View view, int position);
    }
    ...
    public class OnItemChildLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            if (mChildLongClickListener != null) {
                return mChildLongClickListener.onItemChildLongClick(BaseQuickRecycleAdapter.this, v, mViewHolder.getLayoutPosition() - getHeaderViewsCount());
            }
            return false;
        }
    }
     ...
     */
    public BaseQuickRecycleAdapter(int layoutResId, List<T> data) {
    ...
    public BaseQuickRecycleAdapter(List<T> data) {
        this(0, data);
    }

    public BaseQuickRecycleAdapter(View contentView, List<T> data) {
        this(0, data);
    ...
    /**
     * When the current adapter is empty, the BaseQuickRecycleAdapter can display a special view
