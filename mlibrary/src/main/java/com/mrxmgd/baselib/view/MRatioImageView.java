 ...
 * @author MRXMGD <mrxmgd@gmail.com>
 */
public class MRatioImageView extends AppCompatImageView {
    private int heightRatio = 1;
    private int widthRatio = 1;
    private float ratio = 1f;

    public MRatioImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public MRatioImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
