 ...
 */
public class MRatingStarView extends View implements View.OnClickListener {
    ...
    // region constructors
    public MRatingStarView(Context context) {
        super(context);
        init(null, 0);
    }

    public MRatingStarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public MRatingStarView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void loadAttributes(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.MRatingStarView, defStyle, 0);
        strokeColor = a.getColor(R.styleable.MRatingStarView_starStrokeColor, strokeColor);
        starForegroundColor = a.getColor(R.styleable.MRatingStarView_starForegroundColor, starForegroundColor);
        starBackgroundColor = a.getColor(R.styleable.MRatingStarView_starBackgroundColor, starBackgroundColor);
        cornerRadius = a.getDimension(R.styleable.MRatingStarView_starCornerRadius, cornerRadius);
        starMargin = a.getDimension(R.styleable.MRatingStarView_starMargin, starMargin);
        strokeWidth = a.getDimension(R.styleable.MRatingStarView_starStrokeWidth, strokeWidth);
        starThicknessFactor = a.getFloat(R.styleable.MRatingStarView_starThickness, starThicknessFactor);
        rating = a.getFloat(R.styleable.MRatingStarView_rating, rating);
        starNum = a.getInteger(R.styleable.MRatingStarView_starNum, starNum);
        drawStrokeForEmptyStar = a.getBoolean(R.styleable.MRatingStarView_drawStrokeForEmptyStar, true);
        drawStrokeForFullStar = a.getBoolean(R.styleable.MRatingStarView_drawStrokeForFullStar, false);
        drawStrokeForHalfStar = a.getBoolean(R.styleable.MRatingStarView_drawStrokeForHalfStar, true);
        enableSelectRating = a.getBoolean(R.styleable.MRatingStarView_enableSelectRating, false);
        onlyHalfStar = a.getBoolean(R.styleable.MRatingStarView_onlyHalfStar, true);
        a.recycle();
    }
    ...
    private void drawSolidStar(StarModel star, Canvas canvas, int fillColor) {
        ...
        StarModel.VertexF prev = star.getVertex(1);
        Path path = new Path();
        ...
        for (int i = 0; i < 5; i++) {
            ...
            StarModel.VertexF next = prev.next;
