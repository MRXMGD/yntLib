 ...
 * @author MRXMGD <mrxmgd@gmail.com>
 */
public class MRatioLinearLayout extends LinearLayout {
    private int heightRatio = 1;
    private int widthRatio = 1;
    private float ratio = 1f;

    public MRatioLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public MRatioLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public MRatioLinearLayout(Context context) {
        super(context);
    }
